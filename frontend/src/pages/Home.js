...
const FootballMarquee = () => {
  ...
  // Duplicate teams for seamless looping
    ...
    <div className="relative overflow-hidden py-4">
      ...
      <div className="animate-marquee whitespace-nowrap flex items-center">
        {duplicatedTeams.map((team, index) => (
          <div
            key={`${team.id}-${index}`}
            className="flex-shrink-0 mx-10 transition-all duration-500 hover:scale-110"
          >
            <div className="flex flex-col items-center">
              ...
              {/* Team name with minimal styling */}
              <h3 className="mt-3 text-sm font-medium text-blue-400 tracking-wide">
                {team.name}
              </h3>
            </div>
          </div>
